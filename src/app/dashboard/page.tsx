  ...
  return (
    <div className="animate-in slide-in-from-bottom-4 duration-700 ease-out">
      <div className="mb-10 px-2">
        ...
        <p className="text-gray-500 text-sm mt-2 font-medium">Your business performance at a glance.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 px-2">
        {statCards.map((stat, idx) => {
          ...
          return (
            <div key={idx} className="bg-white/60 backdrop-blur-xl p-6 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-white/60 transform transition-all hover:scale-105 duration-300">
              ...
              <div>
                ...
                <p className="text-sm font-semibold text-gray-500 mt-1 uppercase tracking-wider">{stat.title}</p>
              </div>
            </div>
          );
        })}
